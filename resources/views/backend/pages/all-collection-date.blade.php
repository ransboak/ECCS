            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 font-size-18">All Collections @if(\Carbon\Carbon::parse($start_date)->format('jS F Y') == \Carbon\Carbon::parse($end_date)->format('jS F Y') && \Carbon\Carbon::parse($end_date)->format('jS F Y') == \Carbon\Carbon::parse($today)->format('jS F Y')) For Today 
